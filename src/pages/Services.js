        ...
        <Fragment>
            ...
            <div fluid className='BackColor2 text-white w-100 h-auto'>
                <div className='mb-5 w-100 h-auto'>
                    ...
                    <Row className='w-75 mt-5 mx-auto text-center d-block '>
                        <h3 className='pt-5 text-center fw-bold align-self-center'>Our Story</h3>   
                        <h3 className='pt-5 w-75 fw-bold mx-auto grey'>We are a team of 4 friends who started working in the Web3 space as freelancers more than a year ago.  </h3>
                        <h3 className='pt-5 w-75 fw-bold mx-auto grey'>With our combined experience, we were able to spot the weak points of roadmaps and blueprints of our clients and give them an honest and sometimes reality checking opinion.</h3>
                        <h3 className='pt-5 w-75 fw-bold mx-auto grey'>As we started getting closer, we all realized that we share the same passion and work ethic in making Web3 projects and taking our client’s ideas to a refined product.</h3>
                    </Row>
                </div>
            </div>
        </Fragment>
